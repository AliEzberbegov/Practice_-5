...
public class AddFruitSteps {

    private WebDriver driver;

    private static final Logger logger = LoggerFactory.getLogger(AddFruitSteps.class);
    private static final String[] TEST_PRODUCTS = {"Виноград", "Манго"};
